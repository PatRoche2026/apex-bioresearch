...
def _ddp_plans_summary(state: APEXState) -> str:
    """Concatenate the 4 completed plan sections for the Director's synthesis."""
    parts = []
    for role, label in [
        ("cso", "TARGET VALIDATION STRATEGY — Dr. Elena Vasquez, CSO"),
        ("cto", "MODALITY & MANUFACTURING STRATEGY — Dr. Marcus Wei, CTO"),
        ("cmo", "CLINICAL DEVELOPMENT STRATEGY — Dr. Sarah Okonkwo, CMO"),
        ("cbo", "COMMERCIAL & STRATEGIC ASSESSMENT — Dr. James Harrington, CBO"),
    ]:
